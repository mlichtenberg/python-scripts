...
# To confirm the Regularization Hyperparamter value identified in script 09, re-do the 
# initial test of the LogisticRegression algorithm (script 07).
# This time, train the model using the best "C" value, as calculated in script 09.
# Also, pass the algorithm the "class_weight" parameter with a value of "balanced".
...
#   Set here to 0.3... the value identified as the best in script 09
# The 'ravel()' function converts the array to a contiguous flattened array.
#   For example, ravel() will convert the array [[1, 2, 3], [4, 5, 6]] into [1 2 3 4 5 6].
...
# View the recall score against the test data
print("Recall score")
print(metrics.recall_score(Y_test, lr_predict_test))
print()

# A recall score above the desired target (0.7) is confirmed.
